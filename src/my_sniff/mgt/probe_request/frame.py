...
log_pr_frame = create_logger(logger_name=__name__, fmt='%(message)s')
...
======================================================================
			...
			log_pr_frame.info(frame_str)
			# return frame_str
		else:
			import sys
			log_pr_frame('Something wrong with beacon frame display setting. Exiting...')
			sys.exit()
