...
def load_config_packet():
	...
	"""
	import os
	file_path = os.path.join('packet_config', 'config_beacon.ini')
...
def type_value():
	config_packet = load_config_packet()
	type_subtype_json = str(config_packet['Type'].get('subtype_beacon_json'))
	type_subtype_wsdf = str(config_packet['Type'].get('subtype_beacon_WSDF'))
